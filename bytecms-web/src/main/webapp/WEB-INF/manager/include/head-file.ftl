    ...
    <!-- 引入样式 -->
    <link rel="stylesheet" href="${base}/static/plugins/element-ui/2.13.0/index.css">
    <!-- 引入组件库 -->
    <script src="${base}/static/plugins/element-ui/2.13.0/index.js"></script>
    <script src="${base}/static/plugins/element-ui/2.13.0/locale/en_US.js"></script>
    <script src="${base}/static/plugins/element-ui/2.13.0/locale/zh_CN.js"></script>
    <!--图片懒加载-->
    ...
    <script>
        ...
        var editorConfig={
            ...
            serverUrl:  ms.base+"/static/plugins/ueditor/1.4.3.1/jsp/editor.do?jsonConfig=%7BvideoUrlPrefix:\'"+ms.base+"\',fileUrlPrefix:\'"+ms.base+"\',imageUrlPrefix:\'"+ms.base+"\',imagePathFormat:\'/upload/${model}/${beanName}/editor/%7Btime%7D\',filePathFormat:\'/upload/${model}/${beanName}/editor/%7Btime%7D\',videoPathFormat:\'/upload/${model}/${beanName}/editor/%7Btime%7D\'%7D",
