package net.bytecms.core.utils;
...
public class ZipUtil {
    ...
    public static void zip(String sourceFolder, String zipFilePath) throws Exception {
        if(zipFilePath.length()>=3){
            String suffix =FileUtil.getSuffix(zipFilePath);
            if(!Constants.DEFAULT_ZIP_SUFFIX.equals(Constants.DOT+suffix)){
                zipFilePath+= Constants.DEFAULT_ZIP_SUFFIX;
            }
        }
    ...
    public static void unZip(File file, String outputDirectory)
            throws Exception {
        log.debug("开始解压 ["+file+"] 到 ["+outputDirectory+"]");
        org.apache.tools.zip.ZipFile zipFile = new org.apache.tools.zip.ZipFile(file,"utf-8");
...
//          readZipFile("D:\\new1\\文字.zip");
            ...
            //压缩文件
            //String sourceFolder = "C:\\Users\\LG\\Desktop\\费用审批记录查询";
            //String zipFilePath = "C:\\Users\\LG\\Desktop\\费用审批记录查询.zip";
...
//          zip(paths, "D:/abc.zip");
          ...
          unZip("C:\\Users\\LG\\Desktop\\费用审批记录查询.zip", "C:\\Users\\LG\\Desktop\\费用审批记录查询1");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
