...
/**
 * @ClassName: MBaseRedisServiceImpl
 * @Author: LG
 * @Date: 2019/6/6 14:46
 * @Version: 1.0
 **/
@Slf4j
@Service
public class BaseRedisServiceImpl implements BaseRedisService<String, Object> {
    ...
    @Override
    public Set<String> getKeysBlear(String key) {
    ...
    @Override
    public long increment(String key, int delta, long expireTime) {
        long deltaNum= redisTemplate.boundValueOps(key).increment(delta);
