...
public interface BaseRedisService<K, V> {
    ...
    void removeByKeys(final Collection keys);
     ...
     * @return
     */
    long increment(K key,int delta);

    /**
     *
     * @param key  key 自动加 delta
     * @param delta
     * @param expireTime 过期时间
     * @return
     */
    long increment(K key,int delta,long expireTime);
